...
<a href="/assets/imgs/smartmirror/magicmirror_final_cropped.jpg" target="_blank">
    <img src="/assets/imgs/smartmirror/magicmirror_final_cropped.jpg" alt="Smart Mirror" class="project-image" style="width: 600px">
</a>
</div>

I recently built a smart mirror using a Raspberry Pi 4 and a two-way mirror. The project is uses MagicMirror² software,
